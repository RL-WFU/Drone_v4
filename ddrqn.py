...
class DDRQNAgent:
    ...
    def _build_model(self):
        ...
        #first_input = Input(shape=[self.state_size])
    ...
    def load(self, name, name2):
        self.model.load_weights(self.load_weight_dir + name)
        self.target_model.load_weights(self.load_weight_dir + name2)
